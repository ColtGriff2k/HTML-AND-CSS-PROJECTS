...
//Shinks header size when the document is scrolled down by 80 pixels
$(document).on("scroll", function () {
    //When the webpage is scrolled down from the top by 50px this
    //if statement will trigger
if ($(document).scrollTop()>50){
    //Once the 50pz requirement has been met add the
...
$(document).ready(function(){
    ...
    //also close when when an element with the class .dropdown-item (each movie link) has been clicked
